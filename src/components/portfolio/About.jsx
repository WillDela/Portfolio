      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <motion.div {...up(0.3)} className="space-y-7 pt-2">
            ...
            <blockquote className="border-l-4 border-clay-500 pl-6 py-1 my-2">
              <p className="font-display italic text-3xl md:text-4xl text-forest-900 leading-snug">
            ...
            {/* Education */}
            <div className="pt-6 border-t border-forest-900/12 space-y-2">
              ...
              <p className="text-xs text-forest-800/55 leading-relaxed pt-1">
            ...
            {/* Stats */}
            <div className="grid grid-cols-3 gap-6 pt-6 border-t border-forest-900/12">
              {[
                { val: '3.85', label: 'GPA' },
